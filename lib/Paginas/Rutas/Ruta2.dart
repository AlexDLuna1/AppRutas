...
class Ruta2Page extends StatefulWidget {
  const Ruta2Page({super.key});

  @override
  State<Ruta2Page> createState() => _Ruta2PageState();
}

final Uri _url = Uri.parse(
    'https://www.google.com/maps/d/embed?mid=1T3kCWbiShBv8_b7I-hwBif9ZOS2UfQ0&ehbc=2E312F');

class _Ruta2PageState extends State<Ruta2Page> {
  @override
            ...
            child: Container(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    // TEXTO RUTAS
                    const Text('Ruta 2', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
                    ...
                    Center(
                      child: SizedBox(
                        height: 270,
                        child: Image.asset('images/Rutas/Ruta_2.jpg', fit: BoxFit.fitWidth),
                      ),
                    ),
