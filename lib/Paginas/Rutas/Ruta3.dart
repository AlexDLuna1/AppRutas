...
class Ruta3Page extends StatefulWidget {
  const Ruta3Page({super.key});

  @override
  State<Ruta3Page> createState() => _Ruta3PageState();
}

final Uri _url = Uri.parse(
    'https://www.google.com/maps/d/embed?mid=1MiKNhg1wWQKdKgIxQWlLvihCArxshCQ&ehbc=2E312F');

class _Ruta3PageState extends State<Ruta3Page> {
  @override
            ...
            child: Container(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    // TEXTO RUTAS
                    const Text('Ruta 3', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
                    ...
                    Center(
                      child: SizedBox(
                        height: 270,
                        child: Image.asset('images/Rutas/Ruta_3.jpg', fit: BoxFit.fitWidth),
                      ),
                    ),
